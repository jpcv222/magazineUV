<?php return array (
  ...
  'submission.event.participantAdded' => '"{$name}" ({$username}) añadido como {$userGroupName}.',
  'submission.event.participantRemoved' => '"{$name}" ({$username}) eliminado como {$userGroupName}.',
