<?php return array (
  ...
  'plugins.pubIds.urn.description' => 'This plugin enables the assignment of the Uniform Resource Names to monographs, publication formats and files in OMP.',
  ...
  'plugins.pubIds.urn.manager.settings.enableSubmissionURN' => 'Monographs',
  ...
  'plugins.pubIds.urn.manager.settings.urnSuffixPattern' => 'Use the pattern entered below to generate URN suffixes. Use %p for press initials, %m for the monograph id, %f for the publication format id, %s for the file id and %x for "Custom Identifier".',
  ...
  'plugins.pubIds.urn.manager.settings.urnSuffixDefault.description' => '%p.%m for monographs<br />%p.%m.%f for publication formats<br />%p.%m.%f.%s for files.',
  ...
  'plugins.pubIds.urn.manager.settings.urnSubmissionSuffixPatternRequired' => 'Please enter the URN suffix pattern for monographs.',
