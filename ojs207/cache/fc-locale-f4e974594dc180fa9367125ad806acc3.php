<?php return array (
  ...
  'manager.setup.authorCopyrightNoticeDescription' => 'Los términos de la política de derechos de autor que introduzca a continuación se mostrarán en la sección Acerca de la revista y en los metadatos de todos los elementos publicados. A pesar de que es elección de la revista determinar la naturaleza de su acuerdo sobre los derechos de autor, el Public Knowledge Project recomienda la utilización de la licencia <a href="http://creativecommons.org" target="_new" class="action">Creative Commons</a>. Con este fin, proporciona una <a href="{$sampleCopyrightWordingUrl}" target="_new" class="action">muestra de redacción de aviso de derechos de autor</a> que puede ser copiada y pegada en el siguiente espacio para revistas que (a) ofrecen acceso abierto, (b) ofrecen acceso abierto diferido o (c) no ofrecen acceso abierto.',
