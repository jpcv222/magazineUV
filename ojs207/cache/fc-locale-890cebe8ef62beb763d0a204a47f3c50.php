<?php return array (
  ...
  'common.ccLicense' => '<br /><br />
		...
		<br/>
		Ce travail est autorisé sous licence avec la <a rel="license" target="_blank" href="http://creativecommons.org/licenses/by/3.0/">Licence de paternité Creative Commons 3.0</a>.',
  ...
  'common.acknowledged' => 'Vu/Reçu',
  'common.titleSmallWords' => 'de un le et un ou ni mais est si alors autre quand à de par marche arrêt dans hors sur vers dans avec',
  'common.warning' => 'Avertissement/Attention',
  'common.confirm' => 'Confirmer',
  'common.content' => 'Contenu',
  'common.considered' => 'Retenu/Présélectionné',
  'common.declined' => 'Refusé',
  'common.finish' => 'Terminer',
  'common.go' => 'Aller',
  'common.less' => 'Moins',
  'common.billingAddress' => 'Adresse de facturation (si autre)',
  'common.more' => 'Plus',
  'common.notified' => 'Avisé',
  'common.noMatches' => 'Pas de résultats',
  'common.overdue' => 'En retard',
  'common.reminder' => 'Rappel',
  'common.remote' => 'À distance',
  'common.remoteURL' => 'URL distante',
  'common.reset' => 'Réinitialiser',
  'common.signoff' => 'Fermeture de session',
  'common.element' => 'Élément',
  'common.unread' => 'Non lu',
  'common.fileUpload.maxFileSizeStatus' => 'La taille maximale des fichiers téléchargeables sur ce serveur est de {$fileSize}. Pour obtenir de l\'aide, contactez <a href="mailto:{$supportEmail}">{$supportName}</a>.',
  'common.invalidFileType' => 'Aucun fichier téléchargé ou type de fichier invalide!',
  'common.plugins' => 'Plugiciels',
  'email.subjectRequired' => 'Veuillez entrer l\'objet du courriel.',
  'email.bodyRequired' => 'Veuillez entrer le corps de texte du courriel.',
  'form.confirmSubmit' => 'Voulez-vous vraiment envoyer ce formulaire?',
  'form.confirmSubmit.title' => 'Confirmer',
  'form.emailRequired' => 'Une adresse courriel est requise.',
  'form.dataHasChanged' => 'Les données de ce formulaire ont changé. Voulez-vous continuer?',
  'form.invalidImage' => 'L\'image téléchargée est invalide. Seuls les formats .png, .gif et .jpg sont acceptés.',
  'help.toggleInlineHelpOn' => 'Aide activée',
  'help.toggleInlineHelpOff' => 'Aide désactivée',
  'navigation.website' => 'Site Web',
  'navigation.access' => 'Utilisateurs &amp; rôles??',
  'navigation.admin' => 'Administration/Gestion',
  ...
  'navigation.userManagement' => 'Gestion des utilisateurs',
  'grid.action.downloadFile' => 'Télécharger ce fichier',
  'common.error' => 'Erreur',
  'search.activeFilters' => 'Filtres avancés',
  'search.advancedSearchMore' => 'Options de recherche supplémentaires (cliquer pour voir)',
  'search.advancedSearchLess' => 'Options de recherche supplémentaires (cliquer pour masquer)',
  'search.cli.rebuildIndex.clearingIndex' => 'Effacer l\'index',
  'search.cli.rebuildIndex.done' => 'terminé',
  'search.cli.rebuildIndex.error' => 'erreur',
  'search.cli.rebuildIndex.indexing' => 'Indexation "{$journalName}"',
  'search.cli.rebuildIndex.indexingByJournalNotSupported' => 'L\'exécution de cette recherche ne permet pas la réindexation par revue.',
  'search.cli.rebuildIndex.result' => '{$numIndexed} articles indexés',
  'search.cli.rebuildIndex.unknownJournal' => 'L\'adresse de revue donné : "{$journalPath}" n\'a pu mener à une revue.',
  'search.deleteFilter' => 'Supprimer',
  'search.indexTermsLong' => 'index term fields',
