<?php return array (
  ...
  'manager.setup.competingInterests.description' => 'Periódicos da bio-medicina geralmente exigem que autores e avaliadores declarem se há qualquer possibilidade de conflito de interesses com relação à pesquisa (veja <a href="http://www.plosbiology.org/static/competing.action" target="_new">Política PLoS</a>).',
...
&lt;meta name="DC.title" content="Título da revista" /&gt;',
  ...
  'manager.setup.lockssLicenses' => 'Veja <a href="http://www.lockss.org/community/publishers-titles-gln/" target="_blank">outras versões da licença LOCKSS</a>.',
...
Poderão ser usados estatísticas individuais de uso, por exemplo, para exibir uma lista ordenada dos artigos mais usados ou para classificar resultados de pesquisa. Escolha uma das métricas configuradas como padrão.',
  ...
  'manager.setup.permissions.priorAgreement' => 'Acordo prévio',
  'manager.setup.permissions.display' => 'Mostrar',
  'manager.setup.licenseURLDescription' => 'Forneça a URL da página de licença, se disponível.',
  'manager.setup.includeCopyrightStatement' => 'Mostrar a declaração de direitos autorais com o conteúdo (aconselhável para assegurar direitos autorais do autor).',
  'manager.setup.includeLicense' => 'Mostrar a licensa com o trabalho publicado.',
  ...
  'manager.setup.confirmResetLicense' => 'Tem certeza de que deseja redefinir informações sobre direitos autorais e licensas associadas aos conteúdos publicados com a licença configurado na Configuração da Revista?',
  'manager.setup.confirmResetLicenseChanged' => 'Você alterou as informações de licença e direitos autorais na Configuração da Revista. Por favor, salve essas alterações antes de redefinir as permissões.',
  ...
  'manager.subscriptions.form.dateRemindedBefore' => 'Lembrete de pré-vencimento enviado',
  'manager.subscriptions.form.dateRemindedAfter' => 'Lembrete de pós-vencimento enviado',
  'manager.setup.copyrightYearBasis.Article' => 'O ano padrão será deduzido da data de publicação do artigo, como em "publish-as-you-go".',
  'manager.setup.copyrightYearBasis.Issue' => 'O ano padrão será deduzido da data de publicação da edição.',
  'manager.setup.emailHeader' => 'Cabeçalho do email',
  'manager.setup.emailHeaderDescription' => 'Os e-mails predefinidos que são enviados pelo sistema em nome da revista começarão com este cabeçalho. Esses e-mails serão endereçados a partir do contato principal, por isso é importante esclarecer que o contato principal não é necessariamente o responsável pelo conteúdo da mensagem, que pode ser enviado em nome de um usuário diferente.',
); ?>