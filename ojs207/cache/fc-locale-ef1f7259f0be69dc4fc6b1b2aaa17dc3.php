...
<p><strong>Note:</strong> en vue de compléter le processus de vérifications des références dans des délais raisonnables, la directive <tt>citation_checking_max_processes</tt> dans votre fichier de configuration doit être paramétré à une valeur raisonnable. Voir la section "General Settings" dans <tt>config.inc.php</tt> pour plus d\'information.</p>',
  ...
  'manager.announcements.datePublish' => 'Publié/Paru',
  'manager.emails.addEmail' => 'Ajouter un modèle de courriel',
  'manager.emails.data' => 'Modèle message données??',
  'manager.emails.details' => 'Modèle détails/Détails du modèle??',
  'manager.emails.disable.message' => 'Vous êtes sur le point de désactiver ce modèle de courriel. Son utilisation dans d\'éventuels processus système ne sera plus possible. Confirmez-vous l\'opération?',
  'manager.emails.enable.message' => 'Vous êtes sur le point d\'activer ce courriel. Confirmez-vous l\'opération?',
  'manager.emails.resetAll.message' => 'Si vous réinitialisez l\'ensemble des modèles, vous perdrez toutes les modifications aux modèles de courriels. Confirmez-vous cette opération?',
  'manager.emails.reset.message' => 'Si vous réinitialisez ce modèle, toutes les données du message seront ramenées à leur valeur par défaut et les modifications seront annulées. Confirmez-vous cette opération?',
  'manager.masthead.title' => 'Bloc générique',
  'manager.navigation' => 'Navigation',
  'manager.reviewerSearch.advancedSearch.short' => 'Recherche avancée',
  'manager.reviewerSearch.searchByName.short' => 'Recherche par nom',
  'manager.reviewerSearch.form.instructions' => 'Utilisez le formulaire ci-dessous pour établir les valeurs maximales des termes que vous souhaitez rechercher. Les moyennes calculées dans ces champs sont pré-inscrites sur le formulaire.',
  'manager.reviewerSearch.form.interests.instructions' => 'Entrer les intérêts des évaluateurs en les séparant par des virgules...',
  'manager.setup.layout.blockManagement' => 'Gestion de la barre latérale',
  'plugins.categories.metadata' => 'Plugiciels de métadonnées',
  'plugins.categories.metadata.description' => 'Les plugiciels de métadonnées permettent d\'implanter de nouvelles normes de métadonnées.',
  'plugins.categories.citationLookup' => 'Plugiciels…',
  'plugins.categories.citationLookup.description' => 'Les plugiciels [Citation Database Connector] permettent la connexion à des banques de données de citations/références pour consultation, lorsqu\'il y a modification des citations/références, par exemple??',
  'plugins.categories.citationOutput' => 'Plugiciels d\'extraction de citations/références',
  'plugins.categories.citationOutput.description' => 'Les plugiciels [Citation Output] permettent d\'implanter des normes de citation/référence. Ils remplacent les plugiciels de format de citation/référence.',
  'plugins.categories.citationParser' => 'Plugiciels d\'extraction de citations/références',
  'plugins.categories.citationParser.description' => 'Les plugiciels d\'extraction de citations/références permettent d\'extraire des données locales à partir de citations/références brutes (ex. : auteur, titre, etc.).',
  'manager.announcements.form.notificationToggle' => 'Envoyer une notification',
  'manager.announcements.form.notificationToggleInstructions' => 'Créer une nouvelle notification lors de l\'enregistrement de cette annonce.',
