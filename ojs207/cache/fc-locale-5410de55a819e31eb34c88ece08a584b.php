<?php return array (
  ...
  'plugins.importexport.medra.settings.description' => '<a href="{$settingsUrl}">Configure</a> el módulo de exportación mEDRA antes de utilizarlo por primera vez.',
  ...
  'plugins.importexport.medra.reset' => 'Restablecer',
  'plugins.importexport.medra.resetDescription' => 'Haga clic en este botón si desea marcar este objeto como si no se hubiese registrado anteriormente (p. ej. cuando mEDRA envía un mensaje de error al correo electrónico en el primer registro). NO haga clic en este botón cuando reciba un mensaje de error tras un fallo en la actualización.',
  ...
  'plugins.importexport.medra.cliUsage' => 'Uso: {$scriptName} {$pluginName} exportar xmlFileName journal_path {issues|articles|galleys} objectId1 [objectId2] ... {$scriptName} {$pluginName} registrar journal_path {issues|articles|galleys} objectId1 [objectId2] ...',
); ?>