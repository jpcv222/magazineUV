<?php return array (
  ...
  'plugins.pubIds.doi.manager.settings.doiSuffixCustomIdentifier' => 'Informe um sufixo DOI individual para cada item publicado. Ficará disponível um campo DOI adicional na página de metadados de cada item.',
