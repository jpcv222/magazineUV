<?php return array (
  ...
  'user.interests' => 'Intérêts pour les évaluations (Par ex., Biologie sous-marine, Philosophie)',
  ...
  'user.login.changePasswordInstructions' => 'Vous devez sélectionner un nouveau mot de passe avant de pouvoir vous connecter à ce site.<br /><br />Veuillez entrer votre nom d\'utilisateur et vos mots de passe actuels et le nouveau ci-dessous pour modifier le mot de passe de votre compte.',
  ...
  'user.roles' => 'Rôles',
  'user.salutation' => 'Titre de civilité',
  ...
  'user.authorization.processAuthenticationTokenRequired' => 'Le jeton d\'authentification est manquant ou invalide.',
  'user.authorization.contextRequired' => 'Opération impossible sans contexte (presse, revue, conférence, etc.).',
  'user.authorization.loginRequired' => 'Connexion requise/Entrez votre nom d\'utilisateur.',
  'user.authorization.privateOperation' => 'Cette opération ne vous est pas permise ou n\'existe pas.',
  'user.authorization.restrictedSiteAccess' => 'Accès refusé. L\'accès au site est actuellement limité.',
  'user.authorization.roleBasedAccessDenied' => 'Le rôle activé ne peut effectuer cette opération.',
  'user.authorization.userGroupRequired' => 'Vous devez entrer un groupe d\'utilisateurs valide pour effectuer cette opération.',
  'user.authorization.pressManagerRequired' => 'Pour poursuivre, vous devez assigner à cette tâche un utilisateur ayant un rôle de directeur (d\'édition ou de production).',
  'user.interests.description' => '(Énumérer les champs d\'intérêt en les séparant d\'un retour de chariot ou d\'une virgule.)',
  'user.group' => 'Groupe d\'utilisateurs',
  'user.hello' => 'Bonjour,',
  'user.profile.form.countryRequired' => 'Préciser le pays d\'origine.',
  'user.profile.form.mailingAddressRequired' => 'Une adresse postale est requise.',
  'user.profile.form.passwordSameAsOld' => 'Votre nouveau mot de passe est identique à l\'ancien.',
  'user.profile.form.usergroupRequired' => 'Groupe d\'utilisateurs requis.',
  'user.suffix' => 'Suffixe',
  'user.profile.form.hashInvalid' => 'La réinitialisation cryptée du mot de passe que vous avez tenté d\'effectuer n\'est pas valide.',
  'user.login.changePasswordInstructionsOneStep' => 'Vous devez choisir un nouveau mot de passe avant de pouvoir vous connecter à ce site.<br /><br />Veuillez entrer votre nom d\'utilisateur et votre nouveau mot de passe ci-dessous pour changer le mot de passe de votre compte.',
); ?>