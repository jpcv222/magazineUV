...
<li>Use <strong>*</strong> como caracter coringa; ex.: <em>soci* moralidade</em> recuperará documentos contendo "sociedade" ou "sociológico"</li>
  ...
  'about.sponsors' => 'Agências de Fomento',
...
Pode-se opcionalmente informar o motivo pelo qual está sendo desativado o cadastro.',
  ...
  'submission.license' => 'Licensa',
  'submission.copyright' => 'Direitos autorais',
  'submission.copyrightHolder' => 'Detentor dos direitos autorais',
  'submission.copyrightYear' => 'Ano dos direitos autorais',
  'submission.copyrightStatement' => 'Direitos autorais {$copyrightYear} {$copyrightHolder}',
  'submission.licenseURLValid' => 'Informe uma URL válida  (inclua o http://).',
  'submission.licenseURL' => 'URL da licensa',
  ...
  'submission.license.cc.by4' => 'CC Atribuição 4.0',
  ...
  'user.orcid' => 'ORCID iD',
  'user.orcid.description' => 'O identificador ORCID pode ser obtido no <a href="http://orcid.org/" target="_blank">registro ORCID</a>. Você deve aceitar os padrões para apresentação de iD ORCID e incluir a URL completa (por exemplo: <em>http://orcid.org/0000-0002-1825-0097</em>).',
  'user.profile.form.orcidInvalid' => 'O identificador ORCID fornecido é inválido.',
  'manager.setup.preservationDescription' => 'O Open Journal Systems é compatível com o sistema <a href="http://www.lockss.org/" target="_blank"> LOCKSS </a> (Lots of Copies Keep Stuff Safe) para garantir a preservação segura e permanente de sua revista. Você tem várias opções para a inclusão da sua revista em uma rede LOCKSS:',
); ?>