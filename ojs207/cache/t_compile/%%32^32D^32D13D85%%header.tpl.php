...
unset($_smarty_tpl_vars);
 ?><?php echo '<!-- copie desde esta línea---><!--Google Analytics Univalle--><script type="text/javascript"> var _gaq = _gaq || [];_gaq.push([\'_setAccount\', \'UA-2179266-1\']);_gaq.push([\'_setDomainName\', \'.univalle.edu.co\']);_gaq.push([\'_trackPageview\']); (function() '; ?><?php echo ')(); </script><!--Fin Google Analytics--><!-- copie hasta esta línea--->'; ?>
