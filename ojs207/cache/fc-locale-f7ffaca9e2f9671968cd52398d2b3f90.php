<?php return array (
  ...
  'admin.siteSetup' => 'Configuration du site',
  'admin.scheduledTask' => 'Tâche planifiée',
  'admin.scheduledTask.startTime' => 'Tâche commencée.',
  'admin.scheduledTask.stopTime' => 'Tâche arrêtée.',
  'admin.scheduledTask.noLog' => 'La tâche n\'a produit aucun log.',
  'admin.scheduledTask.reviewReminder' => 'Rappel d\'évaluation',
  'admin.scheduledTask.subscriptionExpiryReminder' => 'Rappel de l\'expiration de l\'abonnement',
  'admin.settings.oneStepReset' => 'Utiliser une seule étape pour la réinitialisation du mot de passe ?',
  'admin.fileLoader.wrongBasePathLocation' => 'L\'adresse de base {$path} doit être à l\'intérieur du répertoire de fichiers publics.',
  'admin.fileLoader.pathNotAccessible' => 'Le dossier {$path} n\'est pas un répertoire et n\'est pas en lecture.',
  'admin.fileLoader.moveFileFailed' => 'Le fichier {$filename} n\'a pu être déplacé de {$currentFilePath} à {$destinationPath}',
  'admin.fileLoader.fileProcessed' => 'Le fichier {$filename} a été traité et archivé.',
  'admin.fileLoader' => 'Chargement du fichier',
  'admin.scheduledTask.openAccessNotification' => 'Notification d\'accès libre',
); ?>