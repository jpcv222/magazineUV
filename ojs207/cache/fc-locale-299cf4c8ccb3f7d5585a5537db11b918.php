<?php return array (
  ...
  'plugins.importexport.datacite.settings.description' => '<a href="{$settingsUrl}">Configure</a> el módulo de exportación DataCite antes de usarlo por primera vez.',
  'plugins.importexport.datacite.settings.form.description' => 'Configure el módulo de exportación DataCite:',
  ...
  'plugins.importexport.datacite.export.suppFiles' => 'Exportar archivos complementarios específicos',
  'plugins.importexport.datacite.export.selectSuppFile' => 'Seleccionar archivos complementarios',
  'plugins.importexport.datacite.export.noSuppFiles' => 'Actualmente ningún archivo complementario tiene DOI asignados.',
  'plugins.importexport.datacite.export.error.suppFileNotFound' => 'Ningún archivo complementario se corresponde con la Id. indicada:{$param}.',
  'plugins.importexport.datacite.cliUsage' => 'Uso: {$scriptName} {$pluginName} exportar xmlFileName journal_path {issues|articles|galleys|suppfiles} objectId1 [objectId2] ... {$scriptName} {$pluginName} registrar journal_path {issues|articles|galleys|suppfiles} objectId1 [objectId2] ...',
); ?>