<?php return array (
  ...
  'manager.setup.homepageImageDescription' => 'Ajouter un fichier image ou graphique dans le milieu de la page.',
  ...
  'manager.setup.reviewOptions.automatedReminders' => 'Des rappels automatiques par courriel (disponibles dans les Courriels par défaut d\'OJS) peuvent être envoyés aux évaluateurs à deux moments précis (à tout moment, le rédacteur peut également envoyer un courriel à l\'évaluateur directement)',
  ...
  'manager.setup.contributorNoteDescription' => 'Ce texte apparaîtra sous l\'en-tête « Sources d\'appui » et au-dessus de la liste des noms et urls des organismes de soutien sous « Commanditaires de la revue » sur la page « À propos ».',
  ...
  'manager.setup.publisherNoteDescription' => 'Ce texte apparaîtra sous l\'entête « Éditeur » et au-dessus du nom/url de l\'éditeur sous « Commanditaires de la revue » sur la page « À propos ».',
  'manager.setup.sponsors' => 'Commanditaires de la revue',
  'manager.setup.sponsorNoteDescription' => 'Ce texte apparaîtra sous l\'entête « Commanditaires » et au-dessus de la liste des noms et urls des commanditaires sous « Commanditaires » sur la page « À propos ».',
  ...
  'manager.plugins.wrongCategory' => 'Le plugiciel téléchargé est incompatible avec la catégorie du plugiciel mis à jour.',
  'manager.plugins.wrongName' => 'La version .xml dans le plugiciel téléchargé contient un nom de plugiciel incompatible avec le nom du plugiciel mis à jour.',
  ...
  'manager.setup.subjectClassificationURLValid' => 'Veuillez entrer une URL distante valide (incluant http://).',
  ...
  'manager.setup.permissions.priorAgreement' => 'Accord préalable',
  'manager.setup.permissions.display' => 'Afficher',
  'manager.setup.licenseURLDescription' => 'Fournir l\'URL de la licence du site web, si disponible.',
  'manager.setup.includeCopyrightStatement' => 'Afficher la mention de droit d\'auteur avec le contenu (recommandé lorsque les droits sont détenus par l\'auteur)',
  'manager.setup.includeLicense' => 'Afficher la licence avec l\'oeuvre diffusée.',
  ...
  'manager.setup.confirmResetLicense' => 'Êtes-vous sûr de vouloir réinitialiser la licence et les informations de droits d\'auteur attachés au contenu diffusé pour la licence paramétrée dans la configuration de la revue ?',
  'manager.setup.confirmResetLicenseChanged' => 'Vous avez changé la licence et les informations du droit d\'auteur dans la configuration de la revue. Veuillez enregistrer les changements apportés avant de réinitialiser les autorisations.',
  'manager.setup.copyrightYearBasis' => 'Baser l\'année de mention de droit d\'auteur du nouvel article sur',
  'manager.setup.copyrightYearBasis.Article' => 'L\'année par défaut sera prise de la date de publication de l\'article, comme dans "publish-as-you-go".',
  'manager.setup.copyrightYearBasis.Issue' => 'L\'année par défaut sera prise de la date de publication du numéro.',
  'manager.setup.emailHeader' => 'En-tête du courriel',
  'manager.setup.emailHeaderDescription' => 'Les courriels préparés qui sont envoyés par le système au nom de la revue commenceront par l\'en-tête suivant. Ces courriels seront adressés de la part du contact principal, c\'est donc important de clarifier que le contact principal n\'est pas forcément responsable du contenu du message, celui-ci pourrait être envoyé par un usager différent.',
...
Il y a des cas où seulement une seule statistique d\'utilisation doit être utilisée , ex. pour afficher une liste ordonnée des articles les plus utilisés ou pour classer les résultats de recherche. Veuillez sélectionner l\'une des mesures paramétrées comme celle par défaut.',
  'manager.statistics.reports.aggregationColumns' => 'Regrouper les stats par :',
  'manager.statistics.reports.defaultReportTemplates' => 'Modèle de rapport par défaut',
  ...
  'manager.statistics.reports.defaultReport.issueDownloads' => 'Téléchargements du fichier du numéro',
  'manager.statistics.reports.defaultReport.issueTableOfContents' => 'Vue de la page sommaire du numéro',
  'manager.statistics.reports.defaultReport.issueTableOfContentsAndDownloads' => 'Sommaire du numéro et téléchargements',
  ...
  'manager.statistics.reports.month.label' => 'Utilisez le format AAAAMM.',
  'manager.statistics.reports.day.label' => 'Utilisez le format AAAAMMJJ.',
  'manager.statistics.reports.cities.label' => 'Un ou plusieurs noms de ville, séparés par une virgule (ex. Nom de ville 1,Nom de ville 2)',
  'manager.statistics.reports.form.columnsRequired' => 'Vous devez sélectionner au moins une colonne pour générer le rapport.',
  'manager.statistics.reports.reportUrl' => 'URL du rapport',
  'manager.statistics.reports.reportUrl.label' => 'L\'URL suivante peut être utilisée pour générer le rapport avec les paramètres courants. Copiez-là et collez-là dans votre navigateur puis appuyez sur la touche Entrée. Vous pouvez utiliser vos favoris pour conserver l\'URL qui génère votre rapport personnalisé.',
  ...
  'manager.statistics.reports.filters.byObject' => 'Par type d\'objet et/ou ID d\'objet',
  ...
  'manager.statistics.reports.filters.byTime' => 'Sélectionnez la portée du rapport',
  'manager.statistics.reports.filters.byTime.dimensionSelector' => 'Ou sélectionnez la portée par :',
  'manager.statistics.reports.filters.byLocation' => 'Par géolocation',
  'manager.statistics.reports.filters.byLocation.description' => 'Affiner les résultats par pays, région et/ou ville.',
  'manager.subscriptions.form.dateRemindedBefore' => 'Rappel d\'expiration prochaine envoyé',
  'manager.subscriptions.form.dateRemindedAfter' => 'Rappel que la date d\'expiration est dépassé, envoyé',
); ?>