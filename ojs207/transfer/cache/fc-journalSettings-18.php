<?php return array (
  ...
  'categories' => NULL,
  'contactEmail' => 'samuel.ramirez@correounivalle.edu.co',
  'contactFax' => '',
  'contactName' => 'Samuel Ramierz',
  'contactPhone' => '',
  'contributors' => 
  array (
  ),
  ...
  'emailFooter' => 'El siguiente mensaje es enviado de parte de REVISTA DE PRUEBA.
________________________________________________________________________',
  'emailHeader' => 'El siguiente mensaje es enviado de parte de REVISTA DE PRUEBA.
________________________________________________________________________',
  'emailSignature' => 'El siguiente mensaje es enviado de parte de REVISTA DE PRUEBA.
________________________________________________________________________',
  ...
  'supportEmail' => 'the_gospel_geek@hotmail.com',
  'supportName' => 'Gospel Geek',
  'supportPhone' => '',
  ...
  'authorInformation' => 
  array (
    'es_AR' => '¿Tiene interés en hacer un envío a esta revista? Le recomendamos que revise la sección <a href="/ojsunivalle/ojs/index.php/pruebas/about">Acerca de la revista</a><a> para consultar la política de la misma, así como las </a><a href="/ojsunivalle/ojs/index.php/pruebas/about/submissions#authorGuidelines">Normas de autores/as</a><a>. Los/as autores/as necesitan </a><a href="/ojsunivalle/ojs/index.php/pruebas/user/register">registrarse</a><a> en la revista para poder hacer envíos, o si ya están registrados pueden simplemente </a><a href="/ojsunivalle/ojs/index.php/pruebas/login">identificarse</a><a> y empezar el proceso de 5 pasos.</a>',
  ),
  ...
  'description' => 
  array (
    'es_AR' => '<span><strong>Al contrario del pensamiento popular</strong>, <em>el texto de Lorem Ipsum no es simplemente texto aleatorio. Tiene sus raices en una pieza cl´sica de la literatura del Latin, que data del año 45 antes de Cristo, haciendo que este adquiera mas de 2000 años de antiguedad. Richard McClintock, un profesor de Latin de la Universidad de Hampden-Sydney en Virginia, encontró una de las palabras más oscuras de la lengua del latín, "consecteur", en un pasaje de Lorem Ipsum, y al seguir leyendo distintos textos del latín, descubrió la fuente indudable. Lorem Ipsum viene de las secciones 1.10.32 y 1.10.33 de "de Finnibus Bonorum et Malorum" (Los Extremos del Bien y El Mal) por Cicero, escrito en el año 45 antes de Cristo. Este libro es un tratado de teoría de éticas, muy popular durante el Renacimiento. La primera linea del Lorem Ipsum, "Lorem ipsum dolor sit amet..", viene de una linea en la sección 1.10.32</em></span>',
  ),
...
El tercer párrafo no está justificado.</pre>',
  ...
  'readerInformation' => 
  array (
    'es_AR' => 'Recomendamos a los/as lectores/as que se den de alta en el servicio de notificación de publicación de esta revista. Use el enlace de <a href="/ojsunivalle/ojs/index.php/pruebas/user/register">Registro</a> que se encuentra arriba en la home de la revista. Este registro permitirá al / a la lector/a recibir la Tabla de contenidos por correo-e cada vez que se publique un nuevo número de la revista. Esto también permitirá a la revista conseguir un cierto nivel de soporte y número de lectores/as. Consulte la <a href="/ojsunivalle/ojs/index.php/pruebas/about/submissions#privacyStatement">Política de Privacidad</a> de la revista, que asegura a los/as lectores/as que su nombre y dirección de correo-e no serán usados para otros propósitos.',
  ),
  'refLinkInstructions' => 
  array (
  ...
  array (
    ...
    array (
      ...
      array (
        'order' => '5',
        'content' => 'El texto cumple con los requisitos bibliográficos y de estilo indicados en las <a href="/ojsunivalle/ojs/index.php/pruebas/about/submissions#authorGuidelines">Normas para autoras/es</a>, que se pueden encontrar en Acerca de la revista.',
      ),
      5 => 
      array (
        'order' => '6',
        'content' => 'Si esta enviando a una sección de la revista que se revisa por pares, tiene que asegurase que las instrucciones en <a href="javascript:openHelp(\'http://revistas.univalle.edu.co/ojsunivalle/ojs/index.php/pruebas/help/view/editorial/topic/000044\')">Asegurando de una revisión a ciegas</a>) han sido seguidas.',
      ),
    ),
  ),
