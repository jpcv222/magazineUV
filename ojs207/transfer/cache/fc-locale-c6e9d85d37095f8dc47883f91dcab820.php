...
<li><strong>Edição de texto final.</strong> O editor de texto verificará as alterções realizadas pelo autor, e incorporará as respostas do autor para produzir o documento final. Após concluir, o editor de texto enviará sua versão final por meio do sistema e notificará o editor de layout para produção da versão para publicação.</li>
  ...
  'default.journalSettings.lockssLicense' => 'Esta revista utiliza o sistema LOCKSS para criar um sistema de arquivo distribuído entre as bibliotecas participantes e permite às mesmas criar arquivos permanentes da revista para a preservação e restauração. <a href="http://www.lockss.org/">Saiba mais...</a>',
