<?php return array (
  'plugins.generic.staticPages.displayName' => 'Plugin para Páginas estáticas',
  'plugins.generic.staticPages.description' => 'Este plugin permite el manejo de contenido estático.',
  ...
  'plugins.generic.staticPages.viewInstructions' => '<p>Está página será accesible en:<blockquote>{$pagesPath}</blockquote>...donde %PATH% es la ruta introducida anteriormente. <strong>Nota:</strong> dos páginas no pueden tener la misma ruta. La utilización de rutas integradas en el sistema puede provocar pérdidas de acceso a funciones importantes.</p>',
  'plugins.generic.staticPages.duplicatePath' => 'Esta ruta ya existe para otra página estática.',
  'plugins.generic.staticPages.pageSaved' => 'Página grabada con Éxito.',
