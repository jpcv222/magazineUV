<?php return array (
  ...
  'archive.archives' => 'Números Publicados',
  ...
  'about.onlineSubmissions.newSubmission' => 'Hacer una nueva presentación',
  'about.onlineSubmissions.viewSubmissions' => 'Ver tus envíos pendientes',
  ...
  'log.review.reviewCancelled' => 'La ronda {$round} que {$reviewerName} revisaba para el envío {$submissionId} se canceló.',
  ...
  'log.editor.decision' => '{$editorName} registró una decisión ({$decision}) editorial para el artículo {$submissionId}.',
...
La configuración del soporte CLOCKSS para Open Journal Systems no hace falta que se lleve a cabo hasta que la publicación esté totalmente en marcha.',
  'manager.setup.citations.enable' => 'Activar el asistente de marcado de citas',
