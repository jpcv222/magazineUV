<?php return array (
  ...
  'manager.setup.emailSignatureDescription' => 'La signature suivante sera ajoutée à la fin de chaque courriel préparé et envoyé par le système au nom de la revue.',
  ...
  'manager.setup.enableUserRegistration' => 'Les utilisateurs peuvent s\'inscrire eux-mêmes à la revue.',
  ...
  'manager.setup.journalAbbreviation' => 'Titre cours de la revue',
  ...
  'manager.setup.journalInitials' => 'Abréviation de la revue',
  ...
  'manager.setup.reviewOptions.reviewerAccess' => 'Accès pour l\'évaluateur',
  'manager.setup.reviewOptions.reviewerAccessKeysEnabled' => 'Activer l\'accès en un clic pour l\'évaluateur.',
  'manager.setup.reviewOptions.reviewerAccessKeysEnabled.description' => '<strong>Note :</strong> Le courriel d\'invitation destiné aux évaluateurs contient une URL qui les mène directement à la page d\'évaluation de la soumission. L\'accès à toute autre page requiert de se connecter. Pour des raisons de sécurité, les rédacteurs ne peuvent pas modifier les adresses de courriel, ni ajouter des CC ou CCI avant d\'envoyer une invitation aux évaluateurs.',
  ...
  'manager.setup.siteAccess' => 'Restrictions supplémentaires concernant l\'accès au site et aux articles',
...
Il y a des cas où seulement une seule statistique d\'utilisation doit être utilisée , ex. pour afficher une liste ordonnée des articles les plus utilisés ou pour classer les résultats de recherche. Veuillez sélectionner l\'une des mesures paramétrées comme celle par défaut.',
  ...
  'plugins.importexport.common.settings.form.password.description' => 'Veuillez noter que le mot de passe sera enregistré en plein texte, c-a-d pas encrypté',
...
Il existe cinq niveaux d\'autorisation : Les Directeurs de revue ont accès à tout ce qui se trouve dans un journal (tous les contenus et les paramètres); Les Rédacteurs ont un accès complet à tout le contenu assigné; Les assistants de revue ont un accès limité aux seules soumissions qui leur ont été expressément attribuées par un éditeur; Les Évaluateurs peuvent voir et interagir avec les soumissions qui leur ont été assignés pour évaluation; Et les auteurs peuvent voir et interagir avec une quantité limitée d\'informations en lien avec  leurs propres soumissions. En outre, il y a cinq différentes étapes auquelles les rôles peuvent avoir accès : soumission, évaluation interne, évaluation (review), édition (editorial) et production (production).',
  ...
  'manager.setup.journalAbout.description' => 'Inclure toute information sur votre revue qui pourrait intéresser les lecteurs, les auteurs ou les évaluateurs. Cela peut inclure votre politique de libre accès, les champs d\'intérêt, les questions entourant les droits d\'auteur, la divulgation des commandites, l\'historique de la revue, une déclaration de confidentialité et l\'inclusion dans n\'importe quel système d\'archives LOCKSS ou CLOCKSS.',
