<?php return array (
  ...
  'manager.setup.sortableByComponent' => 'Peut être trié par composante',
  ...
  'manager.reviewerSearch.doneAmount' => 'Nombre d\'évaluations terminée : {$current}',
  'manager.reviewerSearch.avgAmount' => 'Nombre de jours moyen par évaluation: {$current}',
  'manager.reviewerSearch.lastAmount' => 'Jours depuis la dernière évaluation: {$current}',
  'manager.reviewerSearch.activeAmount' => 'Nombre d\'évaluations présentement actives: {$current}',
...
<p><strong>Note:</strong> en vue de compléter le processus de vérifications des références dans des délais raisonnables, la directive <tt>citation_checking_max_processes</tt> dans votre fichier de configuration doit être paramétré à une valeur raisonnable. Voir la section "General Settings" dans <tt>config.inc.php</tt> pour plus d\'information.</p>',
  ...
  'manager.setup.filter.lookup.grid.description.iSBNdb' => '<p>Ce filtre se connecte à la base de données livre et ISBN <a href="http://isbndb.com/" target="_blank">ISBNdb.com</a>.</p>
	<p>Une clé ISBNdb API est obligatoire. Pour plus d\'information sur la génération de la clé, voir la <a href="http://isbndb.com/api/v1/docs/keys" target="_blank">documentation en ligne</a>.</p>',
  ...
  'manager.setup.filter.lookup.grid.description.worldCat' => '<p>Ce filtre se connecte aux services OCLC <a href="http://www.worldcat.org/affiliate/webservices/xisbn/app.jsp" target="_blank">xISBN</a> et <a href="http://www.worldcat.org/" target="_blank">Worldcat</a> (optionnel).</p>
	<p>Si vous avez une <a href="http://oclc.org/developer/develop/web-services.html" target="_blank">clé API</a> Worldcat, vous pouvez vous connecter à Worldcat en saisissant la clé ci-dessous.</p>',
  ...
  'manager.setup.genres.sortable' => 'Permettre aux fichiers de ce type d\'être classés par composante (ex.: chapitre)',
  ...
  'manager.reviewerSearch.searchByName.short' => 'Recherche pas nom',
  ...
  'manager.masthead.title' => 'Bloc-générique',
  ...
  'manager.reviewerSearch.form.interests.instructions' => 'Saisir les intérêts des examinateurs, séparés par des virgules...',
  ...
  'manager.setup.competingInterestsDescription' => 'Les examinateurs devront respecter la politique de divulgation des intérêts concurrents que vous spécifiez ci-dessous.',
  ...
  'manager.setup.reviewOptions.remindForInvite' => 'Envoyer un rappel si l\'examinateur n\'a pas répondu à la demande d\'examen dans le délai suivant (jours):',
  'manager.setup.reviewOptions.remindForSubmit' => 'Envoyer un rappel si l\'examinateur n\'a pas fait sa recommandation dans le délai suivant (jours):',
...
Il arrive parfois qu\'une seule statistique d\'utilisation doit être utilisée, par exemple pour afficher une liste ordonnée des soumissions les plus utilisées ou pour ordonner les résultats de la recherche. Veuillez choisir l\'une des mesures configurées à titre de mesure par défaut.',
  ...
  'plugins.categories.citationLookup' => 'Modules d\'extension pour connecter à la base de données de citations',
  'plugins.categories.citationLookup.description' => 'Les modules d\'extension pour connecter à la base de données de citations permettent d\'accéder aux bases de données pour chercher des citations, ex.: pendant la révision des citations.',
  'plugins.categories.citationOutput' => 'Modules d\'extension pour la production de citations',
  'plugins.categories.citationOutput.description' => 'Les modules d\'extension pour la production de citations mettent en place les normes de citations. Ceci remplace les modules d\'extension du format des citations.',
  'plugins.categories.citationParser' => 'Modules d\'extension pour l\'extraction des citations',
  'plugins.categories.citationParser.description' => 'Les modules d\'extension pour l\'extraction des citations prélèvent des données locales à partir des citations brutes (ex.: auteur, titre, etc.)',
  ...
  'manager.reviewFormElements.required' => 'Les évaluateurs doivent remplir l\'élément',
  'manager.reviewFormElements.smalltextfield' => 'Case de saisie pour un seul mot',
  'manager.reviewFormElements.textarea' => 'Case de saisie élargie',
  ...
  'manager.reviewerSearch.change' => 'Changé',
  'manager.reviewerSearch.doneAmountToggle' => 'Activer/désactiver le filtre pour évaluations complétées.',
  'manager.reviewerSearch.avgAmountToggle' => 'Activer/désactiver le filtre pour moyenne de jours pour compléter une évaluation.',
  'manager.reviewerSearch.lastAmountToggle' => 'Activer/désactiver le filtre pour les jours depuis la dernière évaluation',
  'manager.reviewerSearch.activeAmountToggle' => 'Activer/désactiver le filtre pour les évaluations présentement actives.',
  'manager.reviewerSearch.form.previousReviewRounds' => 'Évaluateurs des rondes précédentes de cette soumission',
  ...
  'manager.setup.peerReview.description' => 'Décrivez la politique et les processus d\'examen par les pairs pour les lecteurs et les auteurs. Cette description comprend souvent le nombre d\'évaluateur impliqués dans l\'examen d\'une soumission, les critères par lesquels les évaluateurs sont invités à juger ces soumissions, le temps prévu pour effectuer les évaluations et enfin, les critères utilisés pour sélectionner les examinateurs.',
  ...
  'manager.setup.privacyStatement.description' => 'Cette déclaration apparaîtra lors de la soumission de l\'auteur et sur la page accessible au public.',
  ...
  'manager.setup.technicalSupportContactDescription' => 'Une personne-ressource qui peut aider les rédacteurs en chef, les auteurs et les évaluateurs à résoudre des problèmes lors d\'une soumission, de l\'édition, de l\'évaluation ou lors de la publication de documents.',
  ...
  'manager.reviewFormElements.included' => 'Inclu dans le message à l\'auteur',
  'grid.action.createReviewForm' => 'Créer un nouveau formulaire d\'évaluation',
  'manager.setup.reviewerCompetingInterestsRequired.description' => 'Déclaration de conflit d\'intérêts de l\'évaluateur',
  'manager.setup.competingInterests.required' => 'Demander une déclaration de conflit d\'intérêts de l\'évaluateur',
