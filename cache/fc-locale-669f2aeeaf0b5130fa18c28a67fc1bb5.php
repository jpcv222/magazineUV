...
<ul>
	<li><a href="http://www.php.net/" target="_blank">PHP</a> >= {$phpRequiredVersion}. Sua versão atual do PHP é {$phpVersion}{$wrongPhpText}</li>
	<li><a href="http://www.mysql.com/" target="_blank">MySQL</a> >= 4.1 or <a href="http://www.postgresql.org/" target="_blank">PostgreSQL</a> >= 9.1.5 (incluindo PosgreSQL 8.x)</li>
...
<p>2. Um diretório para armazenar os arquivos de submissão deve ser criado e com permissão de escrita (veja mais abaixo Configuração de Arquivos).</p>',
...
<p>Defina a variável "installed", no documento de configuração config.inc.php, de novo para <em>On</em>.</p>',
  ...
  'log.review.reviewCancelled' => 'Cancelada a rodada {$round} de avaliação da submissão {$submissionId}, designada a {$reviewerName}.',
...
Pode-se opcionalmente informar o motivo pelo qual está sendo desativado o cadastro.',
  ...
  'manager.setup.citations.enable' => 'Habilitar o Assistente de marcação de citações',
