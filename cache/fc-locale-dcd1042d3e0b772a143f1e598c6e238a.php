<?php return array (
  ...
  'user.login.accountNotValidated' => 'No se ha validado su cuenta de correo electrónico. Compruebe su correo electrónico y siga las instrucciones que se indican. Si no ha recibido el correo electrónico, puede que tenga que contactar con el administrador/a del sitio para obtener ayuda.',
  ...
  'user.login.registrationComplete.instructions' => 'Gracias por su registro en el portal de Revistas de la Universidad del Valle. <br />Qué desea hacer ahora?',
  'user.login.registrationComplete.newSubmission' => 'Realizar el envío de un nuevo artículo',
  'user.login.registrationComplete.continueBrowsing' => 'Continuar explorando la revista.',
