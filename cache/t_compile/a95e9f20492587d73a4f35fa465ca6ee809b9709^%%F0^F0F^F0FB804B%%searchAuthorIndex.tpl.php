<?php /* Smarty version 2.6.25-dev, created on 2018-12-20 14:49:23
...
"><?php if ($this->_tpl_vars['letter'] == $this->_tpl_vars['searchInitial']): ?><strong><?php echo ((is_array($_tmp=$this->_tpl_vars['letter'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</strong><?php else: ?><?php echo ((is_array($_tmp=$this->_tpl_vars['letter'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
<?php $this->_tag_stack[] = array('iterate', array('from' => 'authors','item' => 'author')); $_block_repeat=true;$this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	...
	<?php if (((is_array($_tmp=$this->_tpl_vars['lastFirstLetter'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)) != ((is_array($_tmp=$this->_tpl_vars['firstLetter'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp))): ?>
			<div id="<?php echo ((is_array($_tmp=$this->_tpl_vars['firstLetter'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">
	...
	<?php echo '<a href="'; ?><?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'authors','path' => 'view','firstName' => $this->_tpl_vars['authorFirstName'],'middleName' => $this->_tpl_vars['authorMiddleName'],'lastName' => $this->_tpl_vars['authorLastName'],'affiliation' => $this->_tpl_vars['authorAffiliation'],'country' => $this->_tpl_vars['authorCountry']), $this);?><?php echo '">'; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['authorName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?><?php echo '</a>'; ?><?php if ($this->_tpl_vars['authorAffiliation']): ?><?php echo ', '; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['authorAffiliation'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['lastAuthorName'] == $this->_tpl_vars['authorName'] && $this->_tpl_vars['lastAuthorCountry'] != $this->_tpl_vars['authorCountry']): ?><?php echo ''; ?><?php echo ''; ?><?php if ($this->_tpl_vars['authorCountry']): ?><?php echo ' ('; ?><?php echo $this->_tpl_vars['author']->getCountryLocalized(); ?><?php echo ')'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?>
