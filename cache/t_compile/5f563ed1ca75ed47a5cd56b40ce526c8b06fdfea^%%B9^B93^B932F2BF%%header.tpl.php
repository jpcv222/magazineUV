...
<?php if ($this->_tpl_vars['showingLogo']): ?> has_site_logo_anulado<?php endif; ?>" dir="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['currentLocaleLangDir'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, 'ltr') : smarty_modifier_default($_tmp, 'ltr')); ?>
">
 ...
 <?php echo ((is_array($_tmp=$this->_tpl_vars['loggedInUsername'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
						...
						<?php else: ?>
							<?php if (! $this->_tpl_vars['disableUserReg']): ?>
								<li id="nav_registro_amx" class="gris_blanco_amx"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('router' => @ROUTE_PAGE,'page' => 'user','op' => 'register'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "navigation.register"), $this);?>
</a></li>
							<?php endif; ?>
							<li id="nav_login_amx" class="gris_blanco_amx"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('router' => @ROUTE_PAGE,'page' => 'login'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "navigation.login"), $this);?>
		...
		<?php endif; ?>
		<div class="pkp_structure_content_anulado <?php if ($this->_tpl_vars['hasSidebar']): ?> has_sidebar<?php endif; ?>">
