...
<div class="page_index_journal bordes_amx">
...
">
	...
	<?php endif; ?>
		...
		<div id="contenido_announ" class="cmp_announcements highlight_first">
			<h2>
...
" class="read_more">
	...
	<?php endif; ?>
		...
		<div class="additional_content" style="display:inline">
			<table id="table_add_cont"><tr><td width="15%">&nbsp;</td><td width="70%"><?php echo $this->_tpl_vars['additionalHomeContent']; ?>
