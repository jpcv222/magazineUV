<?php /* Smarty version 2.6.25-dev, created on 2018-12-20 14:47:26
         compiled from frontend/pages/searchAuthorDetails.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'frontend/pages/searchAuthorDetails.tpl', 16, false),array('modifier', 'strip_unsafe_html', 'frontend/pages/searchAuthorDetails.tpl', 29, false),array('modifier', 'nl2br', 'frontend/pages/searchAuthorDetails.tpl', 29, false),array('modifier', 'to_array', 'frontend/pages/searchAuthorDetails.tpl', 34, false),array('function', 'url', 'frontend/pages/searchAuthorDetails.tpl', 29, false),array('function', 'translate', 'frontend/pages/searchAuthorDetails.tpl', 31, false),)), $this); ?>
...
<h3><?php echo ((is_array($_tmp=$this->_tpl_vars['lastName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
<?php endif; ?><?php if ($this->_tpl_vars['affiliation']): ?>, <?php echo ((is_array($_tmp=$this->_tpl_vars['affiliation'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php endif; ?><?php if ($this->_tpl_vars['country']): ?>, <?php echo ((is_array($_tmp=$this->_tpl_vars['country'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php endif; ?></h3>
<ul>
...
</a> - <?php echo ((is_array($_tmp=$this->_tpl_vars['section']->getLocalizedTitle())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</em><br />
...
?>
			&nbsp;<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('journal' => $this->_tpl_vars['journal']->getPath(),'page' => 'article','op' => 'view','path' => ((is_array($_tmp=$this->_tpl_vars['article']->getBestArticleId())) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['galley']->getBestGalleyId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['galley']->getBestGalleyId()))), $this);?>
" class="file"><?php echo ((is_array($_tmp=$this->_tpl_vars['galley']->getGalleyLabel())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a>
