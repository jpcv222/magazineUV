<?php return array (
  ...
  'grid.action.deleteQuery' => 'Aagar comentários',
  ...
  'grid.action.unconsiderReview' => 'Esta revisão está completa, mas você pode desconsiderá-la',
  ...
  'grid.task.status.reviewReady' => 'A revisão está pronte. Clique no ícone de anotação da direita para lê-la.',
  ...
  'grid.user.mergeUsers.into.description' => 'Agora você deve selecionar um usuário ao qual serão atribuídos o histórico de revisão, autorias, etc, do usuário anterior.',
  'grid.user.mergeUsers.from.description' => 'Selecione um usuário para mesclar em outra conta de usuário (por exemplo, quando alguém tem duas contas de usuário). A conta selecionada em primeiro lugar será eliminada e suas submissões, atribuições, etc, serão atribuídos à segunda conta.',
  'grid.user.mergeUsers.allUsers' => 'Todos os usuários registrados',
  'grid.user.mergeUsers.mergeUserSelect.confirm' => 'Tem certeza de que deseja mesclar este usuário com outro? Você vai escolher o próximo usuário na tela seguinte.',
  ...
  'grid.user.mergeUsers.noneEnrolled' => 'Nenhum usuário com este papel.',
