<?php return array (
  'author.submit.userGroupRequired' => 'Seu usuário não está associado a um papel que permite novos envios, tal como o de Autor. Verifique sua conta, pode ser que você mesmo possa se atribuir esse papel editando seu perfil.',
  'author.submit.submissionCitations' => 'Forneça uma lista formatada de citações incluídas nesta submissão.',
  'submission.confirm.message' => 'Seu envio está no sistema e pronto para ser finalizado. Você pode voltar e ajustar as informações fornecidas antes de continuar. Quando pronto, clique em "Finalizar Submissão".',
  ...
  'submission.submit.copyrightNoticeAgree' => 'Concordo em cumprir os termos da declaração de direitos autorais.',
  ...
  'submission.editorial' => 'Edição de Leiaute',
  ...
  'reviewer.submission.reviewFiles' => 'Arquivos da avaliação',
  ...
  'notification.type.editorDecisionPendingRevisions' => 'Avaliação requerida.',
  ...
  'submission.event.fileRevised' => 'Avaliação "{$name}" (ID do arquivo {$fileId} -{$revision}) foi carregado.',
  ...
  'submission.source.tip' => 'Este submissão é derivada de outro recurso? Se assim for, informe uma URL ou uma descrição destes recursos.',
  ...
  'submission.status.production' => 'Em Leiutra de Prova',
  ...
  'submission.submit.uploadSubmissionFile' => 'Carregar Arquivo da Submissão',
  ...
  'submission.upload.noGenre' => 'Gênero ausente ou inválido!',
  'submission.upload.invalidUserGroup' => 'Grupo de usuário inválido ou ausente!',
  'submission.upload.possibleRevision' => 'Detectada Possível Duplicação ou Avaliação (há duvida sobre essa tradução)',
  'submission.upload.possibleRevisionDescription' => 'O nome do arquivo enviado assemelha-se ao nome do arquivo previamente carregado " {$revisedFileName}". Se o arquivo foi carregado para substituir o arquivo mais recente, selecione o arquivo a ser substituído no menu suspenso. Se o arquivo enviado não é para substituir um arquivo mais recente, selecione a opção "Selecionar arquivo (preservar o histórico)."',
  'submission.upload.selectMandatoryFileToRevise' => 'Por favor selecione o arquivo que gostaria de revisar.',
  'submission.upload.selectOptionalFileToRevise' => 'Se você estiver carregando uma avaliação de um arquivo existente, por favor, indique que arquivo.',
  'submission.upload.uploadNewFile' => 'Selecionar arquivo (preservar o histórico)',
  ...
  'editor.submission.roundStatus.resubmitted' => 'A submissão foi enviada para avaliação.',
  ...
  'editor.submission.removeStageParticipant.description' => 'Você está prestes a remover este participante de <strong>todos</ strong> os estágios. Se o usuário tiver tarefas pendentes, eles também serão removidas .',
  ...
  'editor.submission.decision.requestRevisions' => 'Requerer Avaliações',
  'editor.submission.decision.resubmit' => 'Reenviar para Avaliação',
  ...
  'submission.finalDraft' => 'Arquivos de Versão Final',
  ...
  'submission.queries.submission' => 'Comentários pre-avaliação',
  'submission.queries.review' => 'Comentários do avaliador',
  'submission.queries.editorial' => 'Comentários da edição de leiaute',
  'submission.queries.production' => 'Comentário da produção',
  ...
  'submission.query.activity' => 'Há nova atividade numa conversa.',
  'submission.query.new' => 'Há uma demanda a responder.',
  ...
  'submission.supplementary.sponsor' => 'Agência de financiamento ou contribuidores',
  ...
  'submission.event.subjectPrefix' => 'Um email foi enviado:',
  'submission.event.viewEmail' => 'Ver Email',
  ...
  'submission.publisherId' => 'URL de Identificação Pública',
  ...
  'submission.event.participantAdded' => '{$name} foi atribuído a este envio como {$userGroupName}.',
