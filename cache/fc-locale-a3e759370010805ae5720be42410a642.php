<?php return array (
  ...
  'user.authorization.managerRequired' => 'Um usuário com papel de Gerente de Imprensa (Editor de Imprensa ou de Produção, por exemplo) deve ser designado ao estágio antes de proceder.',
  ...
  'user.login.registrationComplete.manageSubmissions' => 'Ver Envios',
  'user.login.registrationComplete.newSubmission' => 'Fazer uma Novo Envio',
  ...
  'user.login.registerNewAccount' => 'Não é um usuário? Registe-se no site',
  ...
  'user.role.layoutEditor' => 'Editor de Leiaute',
  'user.role.layoutEditors' => 'Editores de Leiaute',
  'user.roles' => 'Papéis',
  ...
  'user.orcid' => 'ORCID',
  'user.orcid.orcidInvalid' => 'O ORCID informado é inválido. Por favor inclua a URL completa (ex. "http://orcid.org/0000-0002-1825-0097").',
