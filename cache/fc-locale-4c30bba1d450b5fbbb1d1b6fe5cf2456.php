...
Active indique combien d\'évaluations sont présentement considérées ou en cours.',
  ...
  'sectionEditor.regrets.title' => '#{$submissionId} Message de refus de l\'évaluateur, annulations & cycles précédents',
...
<li>Utiliser <strong>*</strong> comme troncature dans un terme pour y faire correspondre toute séquence de caractères, c.-à-d. <em>soci* moralité</em> feront apparaître les documents contenant « sociologique » ou « socialisme »</li>
  ...
  'about.onlineSubmissions.registrationRequired' => '{$register} et/ou ({$login}) sont obligatoires pour soumettre des articles en ligne.',
...
<h4>Configuration du système recommandé</h4>
...
<p>Si vous n\'êtes pas déjà inscrit et voulez recevoir des nouvelles et mises à jour, <strong>veuillez vous inscrire à <a href="http://pkp.sfu.ca/ojs/register" target="_new">http://pkp.sfu.ca/ojs/register</a>. </strong>Pour toute question ou commentaire, veuillez visiter le <a href="http://forum.pkp.sfu.ca" target="_new">forum de support</a>.</p>',
  ...
  'log.review.reviewRecommendationSetByProxy' => 'La recommandation pour le cycle {$round} d\'évaluation de la soumission {$submissionId} a été établie pas le rédacteur, {$editorName}, au nom de l\'évaluateur, {$reviewerName}.',
  ...
  'log.review.reviewFileByProxy' => 'Le rédacteur, {$userName}, a téléchargé le fichier d\'évaluation pour le cycle {$round} de la soumission {$submissionId} au nom de l\'évaluateur, {$reviewerName}.',
...
Titre du système de classification',
  ...
  'reviewer.article.selectRecommendation' => 'Choisir une recommandation et soumettre l\'évaluation pour compléter le processus. Vous devez écrire une évaluation ou téléverser un fichier avant de choisir une recommandation.',
...
La validation peut échouer sur les URL de recherche qui nécessitent des formulaires de données enregistrés.',
  ...
  'notification.type.articleSubmitted' => 'Un nouvel article, "{$title}", a été soumis.',
  ...
  'user.authorization.copyeditorAssignmentMissing' => 'Accès refusé! Vous n\'avez pas été désigné rédacteur/éditeur de cet article.',
  ...
  'user.register.noContextReviewerInterests' => 'Si vous demandez d\'être évaluateur pour une revue, indiquez vos champs d\'intérêts.',
  ...
  'reviewer.article.selectRecommendation.byEditor' => 'Fixer ou ajuster la recommandation de l\'évaluateur.',
...
L\'installation de CLOCKSS pour Open Journal Systems n\'a pas besoin d\'avoir lieu avant que la publication soit en cours.',
  'manager.setup.citations.enable' => 'Activer l\'Assistant au balisage de référence (Citation Markup Assistant)',
