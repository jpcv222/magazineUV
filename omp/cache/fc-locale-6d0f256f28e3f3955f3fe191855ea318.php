<?php return array (
  ...
  'editor.review.NotifyAuthorAccept' => 'Notify the author that their submission has been accepted.',
  'editor.review.NotifyAuthorDecline' => 'Notify the author that their submission has been declined.',
  'editor.review.NotifyAuthorRevisions' => 'Request revisions from the author.',
  'editor.review.NotifyAuthorResubmit' => 'Request revisions from the author that will be subject to further review.',
  'editor.review.NotifyAuthorExternal' => 'Notify the author of the decision to initiate an external review.',
