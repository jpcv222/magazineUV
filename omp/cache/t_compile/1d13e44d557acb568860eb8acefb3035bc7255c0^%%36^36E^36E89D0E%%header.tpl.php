<?php /* Smarty version 2.6.25-dev, created on 2018-05-29 10:17:58
...
" dir="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['currentLocaleLangDir'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('default', true, $_tmp, 'ltr') : smarty_modifier_default($_tmp, 'ltr')); ?>
">
...
/templates/images/structure/logo.png">
					...
					<ul id="navigationPrimary" class="pkp_navigation_primary pkp_nav_list amx-amx" role="navigation" aria-label="<?php echo ((is_array($_tmp=$this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.navigation.site"), $this))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp));?>
">
