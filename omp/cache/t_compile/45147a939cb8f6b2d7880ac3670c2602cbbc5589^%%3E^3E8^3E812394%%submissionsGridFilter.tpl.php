...
" method="post">
	...
	<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => ((is_array($_tmp='submissionSearchFormArea')) ? $this->_run_mod_handler('concat', true, $_tmp, $this->_tpl_vars['filterData']['gridId']) : $this->_plugins['modifier']['concat'][0][0]->smartyConcat($_tmp, $this->_tpl_vars['filterData']['gridId'])))); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		...
		<?php $this->_tag_stack[] = array('fbvFormSection', array()); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			...
			<?php echo $this->_plugins['function']['fbvElement'][0][0]->smartyFBVElement(array('type' => 'select','name' => 'sectionId','id' => ((is_array($_tmp='sectionId')) ? $this->_run_mod_handler('concat', true, $_tmp, $this->_tpl_vars['filterData']['gridId']) : $this->_plugins['modifier']['concat'][0][0]->smartyConcat($_tmp, $this->_tpl_vars['filterData']['gridId'])),'from' => $this->_tpl_vars['filterData']['sections'],'selected' => $this->_tpl_vars['filterSelectionData']['sectionId'],'size' => $this->_tpl_vars['fbvStyles']['size']['SMALL'],'translate' => false,'inline' => 'true'), $this);?>

		<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
		<?php if ($this->_tpl_vars['filterData']['active']): ?>
			<?php $this->_tag_stack[] = array('fbvFormSection', array('list' => true,'inline' => true)); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
				<?php if ($this->_tpl_vars['filterSelectionData']['orphaned']): ?><?php $this->assign('checked', 'checked'); ?><?php endif; ?>
				<?php echo $this->_plugins['function']['fbvElement'][0][0]->smartyFBVElement(array('type' => 'checkbox','name' => 'orphaned','id' => 'orphaned','value' => '1','checked' => $this->_tpl_vars['checked'],'label' => "grid.submission.active.selectOrphaned",'translate' => 'true'), $this);?>
