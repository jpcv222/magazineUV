	...
	<?php if ($this->_tpl_vars['currentContext']->getLocalizedSetting('copyrightNotice')): ?>
		<div class="copyright_notice">
			<h2>
				...
				<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "frontend/components/editLink.tpl", 'smarty_include_vars' => array('page' => 'management','op' => 'settings','path' => 'journal','anchor' => 'guidelines','sectionTitleKey' => "about.copyrightNotice")));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
			</h2>
