<?php return array (
  ...
  'submission.submit.submissionLocaleDescription' => 'Submissions in several languages are accepted. Choose the primary language of the submission from the pulldown below.',
