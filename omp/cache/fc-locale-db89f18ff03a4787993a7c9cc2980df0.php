<?php return array (
  ...
  'plugins.paymethod.paypal.description' => 'PayPal enables users, whether or not they are PayPal members, to use all major credit cards. The Manager will need to set up a <a href="http://www.paypal.com" target="_blank">PayPal Business Account</a>.',
  'plugins.paymethod.paypal.warning' => 'The Continue button below leads to the PayPal site, where a credit card can be used (without joining PayPal). Use Paypal\'s "Return to Merchant" button after making the payment, which leads back to this site, where the purchased title will be available for downloading.',
